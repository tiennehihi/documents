/*
1. Essay class 
Thiết kế một lớp Essay kế thừa từ lớp GradedActivity được trình bày trong chương 
này. Lớp Essay phải xác định điểm mà học sinh nhận được trên một bài luận. Điểm 
bài luận của sinh viên có thể lên đến 100 và được xác định theo cách sau:
• Grammar: 30 points 
• Spelling: 20 points 
• Correct length: 20 points 
• Content: 30 points
Biểu diễn lớp trong một chương trình đơn giản
*/
#include<bits/stdc++.h>
using namespace std;
class GrateActivity{
